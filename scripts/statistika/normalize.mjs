...
// Среднa възраст — оценка по средните точки на интервалите (методиката е обяснена на страницата).
const MIDPOINTS = { "0-5 год.": 2.5, "6-10 год.": 8, "11-15 год.": 13, "15-20 год.": 17.5, "над 20 год.": 25 };
